...
Washington_All_Grades_All_Formulations_Retail_Gasoline_Prices <- read_csv("~/Documents/Washington_All_Grades_All_Formulations_Retail_Gasoline_Prices.csv", skip = 4)

# View the structure to ensure data is being read correctly
str(Washington_All_Grades_All_Formulations_Retail_Gasoline_Prices)



# View the modified data
View(Washington_All_Grades_All_Formulations_Retail_Gasoline_Prices)

# Check column names of the dataset
colnames(Washington_All_Grades_All_Formulations_Retail_Gasoline_Prices)
