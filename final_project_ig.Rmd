...
## How does average AQI in Clallam and King county compare to the number of EV registrations?
...
# Summarize: average AQI for each county
avg_aqi_by_county <- ad_viz_plotval_data %>%
  group_by(County) %>%  # Replace with exact column name if it's different
  summarise(avg_AQI = mean(`Daily AQI Value`, na.rm = TRUE))  # Replace 'AQI' with your AQI column name
...
## Which EV make is most popular in Washington?

```{r}
library(dplyr)

# Replace 'Make' with your actual column name for the car brand
